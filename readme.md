...
| [**Digital Heritage (Vibe Coding)**](https://github.com/imantahami/digital-heritage) | `React`, `Vite`, `AI-Powered` | An interactive web app showcasing Chicago's architecture, built using **Vibe Coding** and Lovable. |
